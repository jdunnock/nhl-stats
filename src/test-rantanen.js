...
async function main() {
  ...
  try {
    ...
    assert.equal(data.playerId, RANTANEN_ID, "Unexpected player id returned");
    ...
    console.log("✅ Mikko Rantanen 2025-2026 stats fetched successfully");
    console.log(
      JSON.stringify(
        {
...
main().catch((error) => {
  console.error("❌ Mikko Rantanen test failed");
  console.error(error);
  process.exit(1);
});
